# THIẾT KẾ NÂNG CẤP DỮ LIỆU SÀN TOÀN HỆ THỐNG (SYSTEM-WIDE MARKETPLACE DATA ARCHITECTURE)
...
$$	ext{Composite Key} = 	ext{Product\_ID} \ ert \ 	ext{Variant\_ID} \ ert \ 	ext{Platform}$$
